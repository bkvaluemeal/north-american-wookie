...
print('						</select>')
print('					</td>')
print('					<td><input type="text" name="size" value="100"></td>')
print('					<td><input type="text" name="generations" value="500"></td>')
print('				</tr>')
print('				<tr>')
print('					<td></td>')
...
if 'profile' in form:
	result = Wookie(form.getvalue('profile'), int(form.getvalue('size')), int(form.getvalue('generations'))).getBest()
